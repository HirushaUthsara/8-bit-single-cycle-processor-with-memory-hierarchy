...
int main( int argc, char *argv[] )
{
	...
	*************************************************************************/
	char *op_loadi 	= "00000101";   //5
	char *op_mov 	= "00000100";   //4
	char *op_add 	= "00000000";   //0
	char *op_sub 	= "00000001";   //1
	char *op_and 	= "00000010";   //2
	char *op_or 	= "00000011";   //3
	char *op_j		= "00000110";   //6
	char *op_beq	= "00000111";   //7
	char *op_lwd 	= "00001000";   //8
	char *op_lwi 	= "00001001";   //9
	char *op_swd 	= "00001010";   //10
	char *op_swi 	= "00001011";   //11
	/************************************************************************/
